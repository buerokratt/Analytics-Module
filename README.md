...
For production deploying on kubernetes use this the variable [`REACT_APP_MENU_JSON`](https://github.com/buerokratt/NoOps/blob/dev/Kubernetes/Modules/Analytics-Module/templates/deployment-byk-analytics-gui.yaml):
```
